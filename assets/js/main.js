...
if (mainFeaturedActivityContainer && typeof activitiesData !== 'undefined') {
    ...
    if (featuredActivity) {
        ...
        // جلب النصوص المترجمة لكرت الهوم مباشرة لمنع اختفائها عند إعادة التحميل
            ...
            <div class="hub-card-item" data-id="${featuredActivity.id}">
                ...
                <div class="hub-card-content">
                    ...
                    <div class="hub-card-footer">
                        <a href="${featuredActivity.link}" class="btn-hub-link">
...
// تشغيل الأزرار والتهيئة الأولية في صفحة الأنشطة
if (activitiesPageGrid && typeof activitiesData !== 'undefined') {
    // التشغيل الأولي المستقر
    window.renderActivities("all");

    // مستمعات الفلترة المستقرة لمفاتيح التصنيفات
