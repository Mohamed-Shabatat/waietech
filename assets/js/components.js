        ...
        headerElement.innerHTML = `
            <nav class="navbar">
                ...
                <ul class="nav-links" id="nav-links">
                    ...
                    <li><i class="fas fa-calendar-alt nav-icon"></i><a href="events.html" data-i18n="nav_events">الأحداث</a></li>
            ...
            <div class="footer-wrapper">
                <div class="footer-grid">
                    ...
                    <div class="footer-col">
                        ...
                        <ul class="footer-links">
                            <li><a href="events.html" data-i18n="nav_events">الورش والفعاليات</a></li>
                            <li><a href="blog.html" data-i18n="nav_blog">مدونة التوعية</a></li>
                            <li><a href="#" data-i18n="nav_impact">إنجازاتنا</a></li>
                        </ul>
                    </div>
